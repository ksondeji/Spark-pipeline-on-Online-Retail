...
def test_purchase_segment_by_order_amount(spark):
    raw = spark.createDataFrame(
        [
            ("536365", "85123", "A", 1, "01/12/2010 08:26:00", 2.0, "17850", "United Kingdom"),
            ("536366", "85124", "B", 1, "01/12/2010 08:26:00", 10.0, "17851", "Germany"),
            ("536367", "85125", "C", 1, "01/12/2010 08:26:00", 50.0, "17852", "France"),
        ],
        [
            "InvoiceNo",
            "StockCode",
    ...
    segments = {row["Purchase_segment"] for row in enriched}
    assert segments == {"Low", "Medium", "High"}
    assert enriched[2]["High_spender"] is True
